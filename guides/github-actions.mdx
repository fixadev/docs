...
- `agent_id` (required): the id of your fixa agent
- `scenario_ids` (optional): comma-separated list of specific scenarios to test. leave it blank to test all scenarios
- `test_agent_ids` (optional): comma-separated list of test agents to use. leave it blank to use all test agents
- `time_limit` (optional): test duration limit in minutes (default: 10)
